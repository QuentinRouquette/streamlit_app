...
# Télécharger les données sous forme de GeoPackage ou KML
@st.cache
...
# Créer un bouton pour télécharger les données OSM en GeoPackage ou KML
...
if not power_lines.empty or not substations.empty:
    ...
    download_format = st.radio("Choisir le format de téléchargement", ("GeoPackage", "KML"))
    
    if download_format == "GeoPackage":
